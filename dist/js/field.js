...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-multi-select', __webpack_require__(4));
    Vue.component('detail-multi-select', __webpack_require__(7));
    Vue.component('form-multi-select', __webpack_require__(10));
});
    ...
    _c(
      ...
      _vm._l(_vm.field.value, function(item) {
        return _c(
          ...
          {
            staticClass:
              "flex-none rounded-lg cursor-default text-center text-white bg-primary px-2 py-1 mr-1 mb-1"
          },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_selectize__ = __webpack_require__(13);
        ...
        $select.selectize(_extends({
            ...
            render: {
                item: function item(_item, escape) {
                    return '<div class="flex-none rounded-lg cursor-default text-center text-white bg-primary px-2 py-1 mr-1 mb-1">' + '<span>' + escape(_item[_this.field.optionLabel]) + '</span>' + '<span onClick="$(\'#' + _this.field.attribute + '\').get(0).selectize.removeItem(\'' + _item[_this.field.optionValue] + '\')" class="ml-1 px-1 rounded cursor-pointer font-bold border-transparent hover:bg-primary-dark">x</span>' + '</div>';
                },
...
(function(root, factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1),__webpack_require__(14),__webpack_require__(15)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
